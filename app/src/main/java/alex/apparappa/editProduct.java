...
public class editProduct extends Activity {
    ...
    // single product url
    private static final String url_product_details = "http://www.apparappa.altervista.org/appaServices/get_product_details.php";

    // url to update product
    private static final String url_update_product = "http://www.apparappa.altervista.org/appaServices/update_product.php";
    ...
    private static final String TAG_PRODUCT = "prodotti";
    private static final String TAG_PID = "idprodotto";
    private static final String TAG_NAME = "nome";
    private static final String TAG_PRICE = "prezzo";
